...
import uk.gov.gsi.justice.spg.UDLoggingInInterceptor;
import uk.gov.gsi.justice.spg.audit.UDInterchangeAuditLogService;
import uk.gov.gsi.justice.spg.audit.UDSPGLogFields;
...
import static uk.gov.gsi.justice.spg.av.AntivirusResponse.Status.ERROR;
import static uk.gov.gsi.justice.spg.av.AntivirusResponse.Status.FAILED;
