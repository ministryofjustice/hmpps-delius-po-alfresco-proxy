...
public class AlfrescoProxyHealthCheckerTest {
  ...
  private final DependencyHealthChecker<AlfrescoHealth> alfrescoHealthChecker =
      mock(DependencyHealthChecker.class);

  @SuppressWarnings("unchecked")
  private final DependencyHealthChecker<ClamAvHealth> clamAvHealthChecker =
      mock(DependencyHealthChecker.class);

  private final AlfrescoProxyHealthChecker sut =
      new AlfrescoProxyHealthChecker(
          applicationName,
          objectMapper,
          timestampProvider,
  ...
  public void testWhenBothAlfrescoAndClamAvAreHealthy() throws Exception {
    ...
    final String expectedResult =
        objectMapper.writeValueAsString(
            new ApiHealth(applicationName, stable, unmodifiableMap(dependencies), timestamp));
  ...
  public void testWhenBothAlfrescoAndClamAvAreUnhealthy() throws Exception {
    ...
    final String expectedResult =
        objectMapper.writeValueAsString(
            new ApiHealth(applicationName, unstable, unmodifiableMap(dependencies), timestamp));
