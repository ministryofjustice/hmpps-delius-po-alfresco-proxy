...
public class SelfSignedCertificateGenerator {
  ...
  public static X509Certificate generate(
      final KeyPair keyPair, final String hashAlgorithm, final String cn, final int days)
    ...
    final ContentSigner contentSigner =
        new JcaContentSignerBuilder(hashAlgorithm).build(keyPair.getPrivate());
    ...
    final X509v3CertificateBuilder certificateBuilder =
        new JcaX509v3CertificateBuilder(
                ...
                keyPair.getPublic())
            .addExtension(
                Extension.subjectKeyIdentifier, false, createSubjectKeyId(keyPair.getPublic()))
            .addExtension(
                Extension.authorityKeyIdentifier, false, createAuthorityKeyId(keyPair.getPublic()))
   ...
   * @throws OperatorCreationException on create subject key id
   */
   ...
   * @throws OperatorCreationException on create authority key id
   */
