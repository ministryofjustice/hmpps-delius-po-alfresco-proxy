  ...
  terraform {
    extra_arguments "common_vars" {
      ...
      arguments = [
        ...
        "-var-file=${get_parent_tfvars_dir()}/spg-env-configs/spg-common.tfvars",
        "-var-file=${get_parent_tfvars_dir()}/spg-env-configs/${get_env("TG_ENVIRONMENT_NAME", "ENVIRONMENT")}.tfvars",
