...
public class AlfrescoHealthChecker implements DependencyHealthChecker<AlfrescoHealth> {
  private static final Logger LOGGER = LoggerFactory.getLogger(AlfrescoHealthChecker.class);
  private final WebClient alfrescoClient;

  public AlfrescoHealthChecker(
      @Value("${alfresco.base.url}") final String alfrescoBaseUrl,
