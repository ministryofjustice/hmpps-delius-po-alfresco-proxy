...
/** @deprecated Use AntivirusClient instead */
@Deprecated
public class AntivirusScanner {
  ...
  public AntivirusScanner(
      final ClamAvConnectionParametersProvider clamAvConnectionParametersProvider) {
  ...
  public AntivirusResponse scanBytes(InputStream is) {
    ...
    LOGGER.info(
        "============================== Connecting to ClamAV with the following parameters ==============================");
    ...
    try {
      try {
        ...
        return new AntivirusResponse(
            new AntivirusException("Could not open socket OutputStream", e));
      }
          ...
          for (int i = 1; i <= RETRY_TIMES; i++) {
            try {
              ...
              if (i == RETRY_TIMES) {
                ...
                return new AntivirusResponse(
                    new AntivirusException("Error writing data to socket", e));
              }
            }
          }
        }
