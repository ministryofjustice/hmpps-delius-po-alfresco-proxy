...
public interface SPGUnstructuredService {
  ...
  /**
   * Used to upload a previously "fetchandreserved" document Same as uploadnew, except needs the
   * doc_id as a path parameter
   *
   * @param documentId
   * @return
   * @throws Exception
  ...
  @Path("/uploadparam")
  @Produces(MediaType.APPLICATION_JSON)
  Response testpost(@PathParam("CRN") String crnId);

  @POST
  @Path("/uploadbean")
  @Produces(MediaType.APPLICATION_JSON)
  Response testpost1(Object bean);
  ...
  @Produces(MediaType.APPLICATION_JSON)
  Response testpost3(MultipartBody crnId);
