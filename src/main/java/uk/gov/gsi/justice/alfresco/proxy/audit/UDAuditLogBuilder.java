package uk.gov.gsi.justice.alfresco.proxy.audit;
...
public class UDAuditLogBuilder {
  ...
  public static String createAuditLog(
      String logType, String timestamp, Message message, long roundTripTimeMillis) {
  ...
  public static String createAuditLog(
    ...
    String from =
        headerMap == null
            ? "ALF"
            : (headerMap.containsKey("X-DocRepository-Remote-User")
                ? String.valueOf(headerMap.get("X-DocRepository-Remote-User"))
                : "ALF");
    ...
    auditLogEntry
        .append("|")
        .append(UDSPGLogFields.UD_ID)
        .append("=")
        .append(message.get(LoggingMessage.ID_KEY));
    auditLogEntry
        .append("|")
        .append(UDSPGLogFields.UD_MESSAGE_TYPE)
        .append("=")
        .append(messageType);
    if (roundTripTimeMillis > 0) {
      auditLogEntry
          .append("|")
          .append(UDSPGLogFields.UD_ROUNDTRIP_TIME)
          .append("=")
          .append(Long.valueOf(roundTripTimeMillis));
    }

    auditLogEntry
        .append("|")
        .append("INBOUND_MESSAGE")
        .append("=")
        .append(getMessageValue(message, Message.INBOUND_MESSAGE));
    auditLogEntry
        .append("|")
        .append("HTTP_REQUEST_METHOD")
        .append("=")
        .append(getMessageValue(message, Message.HTTP_REQUEST_METHOD));
    auditLogEntry
        .append("|")
        .append("REQUEST_URL")
        .append("=")
        .append(getMessageValue(message, Message.REQUEST_URL));
    auditLogEntry
        .append("|")
        .append("RESPONSE_CODE")
        .append("=")
        .append(getMessageValue(message, Message.RESPONSE_CODE));
    if (buffer != null) {
    ...
    if (message.get(UDSPGLogFields.UD_ERRDESC.toString()) != null) {
      ...
      auditLogEntry
          .append("|")
          .append(UDSPGLogFields.UD_ERRDESC.toString())
          .append("=")
          .append(message.get(UDSPGLogFields.UD_ERRDESC.toString()));
      auditLogEntry
          .append("|")
          .append(UDSPGLogFields.UD_CRN.toString())
          .append("=")
          .append(message.get(UDSPGLogFields.UD_CRN.toString()));
    }
