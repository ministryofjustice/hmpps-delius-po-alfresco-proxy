...
public class UDInterchangeAuditLogService {
  ...
  private static final String AUDIT_SERVICE_INITIALISATION_MSG =
      "Initialising SPGInterchange Log Service";
  private static final String AUDIT_SERVICE_DESTROY_MSG = "Shutting Down Audit Logging Service";
  private static final String SPG_UD_AUDITLOG_AUDIT_LEVEL_LOGNAME =
      UDAuditLog4jLevel.class.getName();
  private static final String SPG_UD_AUDITLOG_ALERT_LEVEL_LOGNAME =
      UDAlertLog4jLevel.class.getName();
  private static final String SPG_UD_AUDITLOG_SECURITY_LEVEL_LOGNAME =
      UDSecurityLog4jLevel.class.getName();
  private static final String SPG_AUDITLOG_AUDIT_SERVICE_LOGNAME =
      UDInterchangeAuditLogService.class.getName();
  ...
  public void createUDAuditRecord(String logRecord) {
    ...
    unstructuredAuditlog.log(
        UDAuditLog4jLevel.AUDIT, "AUDIT " + logRecord); // log to audit log appender
  }

  public void createUDSecurityAuditRecord(String logRecord) {
    logService.log(UDAuditLog4jLevel.INFO, logRecord); // log to main log
    unstructuredSecuritylog.log(
        UDSecurityLog4jLevel.SECURITY, logRecord); // log to audit log appender
  }

  public void createUDAlertRecord(String logRecord) {
    logService.log(UDAuditLog4jLevel.WARN, logRecord); // log to main log
    unstructuredAlertlog.log(
        UDAlertLog4jLevel.ALERT, "ALERT " + logRecord); // log to audit log appender
  }
